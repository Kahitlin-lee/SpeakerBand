package com.speakerband.musica.cursor;
...
public class SongCursor {
    ...
    private static ClaseApplicationGlobal mApplicationAux;
    ...
    {
        Cursor _musicCursor;
        mApplicationAux = (ClaseApplicationGlobal) mApplicationAux.getContext ();
